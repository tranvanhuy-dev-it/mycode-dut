...
def gradient_descent_momentum(alpha, beta, x0, grad_thresh=1e-5, max_iter=1000):
    ...
    for it in range(max_iter):
        ...
        if abs(gradient) < grad_thresh:
            print(f"Gradient Descent với Momentum dừng sau {it} vòng lặp.")
            break
...
if __name__ == "__main__":
    ...
    x_min, history = gradient_descent_momentum(alpha, beta, x0)
